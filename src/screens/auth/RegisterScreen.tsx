...
function RegistrationHeader({ step, onBack, onSkip }: { step: number; onBack: () => void; onSkip: () => void }) {
  return (
    <View style={screenStyles.header}>
      ...
      <Svg width="100%" height={92} viewBox="0 0 390 92" preserveAspectRatio="none" style={screenStyles.headerWave}>
        <Path d="M0 41 C68 21 145 22 222 44 C292 64 344 54 390 17 L390 92 L0 92 Z" fill="#f8fafc" />
        <Path d="M0 45 C72 26 148 27 224 48 C292 66 346 57 390 21 L390 92 L0 92 Z" fill="#ffffff" opacity={0.98} />
      </Svg>
...
const screenStyles = StyleSheet.create({
  ...
  verifiedPill: { marginTop: 28, alignSelf: "flex-start", height: 30, borderRadius: 999, paddingHorizontal: 14, borderWidth: 1.2, borderColor: "#bddbf2", backgroundColor: "#e8f4ff", flexDirection: "row", alignItems: "center", gap: 8 },
  ...
  tipBox: { marginTop: 2, borderRadius: 16, borderWidth: 1.2, borderStyle: "dashed", borderColor: "#a7d4f2", backgroundColor: "#f2f8ff", padding: 14, flexDirection: "row", gap: 12, alignItems: "center" },
  tipBoxLarge: { marginTop: 28, borderRadius: 16, borderWidth: 1.2, borderStyle: "dashed", borderColor: "#a7d4f2", backgroundColor: "#f2f8ff", padding: 16, flexDirection: "row", gap: 12, alignItems: "flex-start" },
  tipIcon: { fontSize: 20 },
  ...
  input: { height: 51, borderRadius: 15, borderWidth: 1.2, borderColor: "#dfe6ee", backgroundColor: "#f9fbfd", paddingHorizontal: 17, fontFamily: jakarta.extraBold, color: colors.navy, fontSize: 15 },
  fieldHelper: { marginTop: 6, fontFamily: jakarta.bold, color: "#9ba6b3", fontSize: 10 },
  twoCol: { flexDirection: "row", gap: 14 },
  colField: { flex: 1 },
  optionPanel: { marginTop: 10, borderRadius: 15, borderWidth: 1, borderColor: "#dfe6ee", backgroundColor: "#f9fbfd", overflow: "hidden" },
  ...
  optionRowActive: { backgroundColor: "#e8f4ff" },
  ...
  selectBox: { height: 56, borderRadius: 15, borderWidth: 1.2, borderColor: "#dfe6ee", backgroundColor: "#f9fbfd", paddingHorizontal: 17, flexDirection: "row", alignItems: "center" },
  ...
  uploadCount: { minWidth: 104, height: 28, borderRadius: 999, borderWidth: 1.2, borderColor: "#dfe6ee", backgroundColor: "#f9fbfd", textAlign: "center", lineHeight: 28, fontFamily: jakarta.extraBold, color: colors.muted, fontSize: 12 },
  ...
  completeWrap: { flex: 1, backgroundColor: "#f8fafc" },
  ...
  activePill: { height: 28, paddingHorizontal: 14, borderRadius: 999, borderWidth: 1.2, borderColor: "#a7d4f2", backgroundColor: "#e8f4ff", flexDirection: "row", alignItems: "center", gap: 8 },
  ...
  reviewBox: { borderColor: "#a7d4f2", backgroundColor: "#f2f8ff" },
