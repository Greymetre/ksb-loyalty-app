...
const screenStyles = StyleSheet.create({
  ...
  walletCardSelected: { borderColor: "#dcb877", shadowColor: colors.primary, shadowOpacity: 0.12 },
  ...
  statusPillSuccess: { borderColor: "#dcb877", backgroundColor: "#faf0dd" },
  ...
  schemeSectionHighlighted: { borderColor: "#dcb877", backgroundColor: "#fdf6ea", shadowColor: colors.primary, shadowOpacity: 0.14, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 4 },
  ...
  schemeCardActive: { borderColor: colors.primary, backgroundColor: "#faf0dd" },
  ...
  tipBox: { marginTop: 30, borderRadius: 16, borderWidth: 1.2, borderStyle: "dashed", borderColor: "#dcb877", backgroundColor: "#fdf6ea", paddingHorizontal: 18, paddingVertical: 18, flexDirection: "row", gap: 14, alignItems: "flex-start" },
  ...
  walletPill: { marginBottom: 34, alignSelf: "flex-start", maxWidth: "100%", minHeight: 38, borderRadius: 999, borderWidth: 1.2, borderColor: "#e2c58c", backgroundColor: "#faf0dd", paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 10 },
  ...
  balanceRow: { marginTop: 28, minHeight: 58, borderRadius: 18, backgroundColor: "#fdf9f1", paddingHorizontal: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 14 },
  ...
  verifiedBadge: { height: 26, borderRadius: 999, borderWidth: 1.2, borderColor: "#dcb877", backgroundColor: "#faf0dd", paddingHorizontal: 11, flexDirection: "row", alignItems: "center", gap: 7 },
  ...
  bankConfirmBoxActive: { borderColor: "#dcb877", backgroundColor: "#faf0dd" },
  ...
  transferOption: { minWidth: 70, height: 34, borderRadius: 999, borderWidth: 1.2, borderColor: "#dfe6ee", backgroundColor: "#fdf9f1", alignItems: "center", justifyContent: "center", paddingHorizontal: 12 },
  transferOptionActive: { borderColor: "#dcb877", backgroundColor: "#faf0dd" },
  ...
  paymentPill: { overflow: "hidden", borderRadius: 999, borderWidth: 1, borderColor: "#dcb877", backgroundColor: "#faf0dd", paddingHorizontal: 10, paddingVertical: 2, fontFamily: jakarta.extraBold, color: colors.primary, fontSize: 10 },
  ...
  receiveBox: { marginTop: 22, minHeight: 72, borderRadius: 16, borderWidth: 1.2, borderColor: "#e2c58c", backgroundColor: "#fdf6ea", paddingHorizontal: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  ...
  trackerDot: { width: 38, height: 38, borderRadius: 19, borderWidth: 1.2, borderColor: "#dfe6ee", backgroundColor: "#fdf9f1", alignItems: "center", justifyContent: "center" },
