...
const s = StyleSheet.create({
  ...
  details: { flexDirection: "row", flexWrap: "wrap", rowGap: 19 },
  // The details grid lays cells out two to a row, so the note has to claim the
  // whole width or it would sit beside the scheme instead of under it.
  schemeNote: { width: "100%", marginTop: -13, fontFamily: jakarta.medium, color: "#64748b", fontSize: 11.5, lineHeight: 16 },
